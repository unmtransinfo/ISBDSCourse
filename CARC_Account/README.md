...
# (1/5) How to setup your account for computations on Center for Advanced Research and Computing (CARC) at UNM? 
...
# (2/5) After you have obtained your passwords for the two clusters
...
# (3/5) Some useful commands on Terminal on local machine 
...
# (4/5) How to access servers via JupyterHub? 
